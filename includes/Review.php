        ...
        public function add_notification() {
            if (function_exists('get_current_screen')) {
                if (get_current_screen()->id == 'plugins' || get_post_type() == 'telegram-accounts' ) {
                    ...
                    <script>
                    jQuery("#njt_tele-review a").on("click", function () {
                        ...
                        jQuery.ajax({
                            ...
                            if (result.success) {
                                if (hidePopup == true) {
                                    jQuery('#njt_tele-review').hide("slow");
                                }
                            } else {
...
if ( !class_exists('NJTTelegramReview') ) {
    class NJTTelegramReview extends NjtReview {}
    NJTTelegramReview::get_instance('njt_tele', 'Telegram Plugin', 'ninjateam-telegram');
}
